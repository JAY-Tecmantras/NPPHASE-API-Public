...
namespace NPPHASE.Apis.Controllers
{
    ...
    public class GalleryController : BaseController<Gallery>
    {
        ...
        public GalleryController(IService<Gallery> service, IGalleryService galleryService, IDeviceUserServices deviceUserServices) : base(service, deviceUserServices)
        {
            _service = service;
