...
namespace NPPHASE.Apis.Controllers
{
    ...
    public class GalleryCController : BaseController<Gallery>
    {
        ...
        public GalleryCController(IService<Gallery> service, IGalleryService galleryService, IDeviceUserServices deviceUserServices) : base(service, deviceUserServices)
        {
            _service = service;
