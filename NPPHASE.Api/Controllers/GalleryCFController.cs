...
namespace NPPHASE.Apis.Controllers
{
    ...
    public class GalleryCFController : BaseController<Gallery>
    {
        ...
        public GalleryCFController(IService<Gallery> service, IGalleryService galleryService, IDeviceUserServices deviceUserServices) : base(service, deviceUserServices)
        {
            _service = service;
