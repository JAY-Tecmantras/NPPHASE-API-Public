...
namespace NPPHASE.Apis.Controllers
{
    ...
    public class HomeControllerTestCopy : ControllerBase
    {
        private readonly IActionResult _result;
        private readonly ILogger<HomeControllerTestCopy> _logger;

        private readonly IHomeService _deviceService;
        private readonly IExceptionLoggerServices _exceptionLoggerServices;
        public HomeControllerTestCopy(IHomeService deviceService, IExceptionLoggerServices exceptionLoggerServices)
        {
